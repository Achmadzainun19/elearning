        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="callout callout-info">
                    <h4><b>Informasi :</b></h4>
                    <?php
                        $data=mysqli_query($koneksi,"select * from materi left join ampu on ampu.id_ampu=materi.id_ampu left join kelas on kelas.id_kelas=ampu.id_kelas left join guru on guru.id_guru=ampu.id_guru left join mapel on mapel.id_mapel=ampu.id_mapel where  materi.id_materi='$_GET[id_materi]'");
            ...
            <div class="col-md-8 col-md-offset-2 ">
              ...
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li class="pull-right"><a href="javascript:void(0);" id="<?php echo $_GET['id_materi'];?>" ampu="<?php echo $id_ampu; ?>"class="text-muted hapus-materi"><i class="fa fa-trash"></i></a></li>
                </ul>
                ...
                <!-- panel preview materi -->
                  ...
                  <div class="tab-pane" id="tab_2">
                    ...
                    while($d = mysqli_fetch_array($data_materi)){           
                    ?>
                      <form method="post" action="http://localhost/elearning/guru/?system=materi&aksi=edit_materi" enctype="multipart/form-data">
                      ...
                      <div class="">
                          <div class="box box-default collapsed-box">
                              ...
                              <div class="box-footer">
                                  <form action="http://localhost/elearning/guru/?system=materi&aksi=tambah_komentar&id_materi=<?php echo $_GET['id_materi']; ?>" method="post">
...
<div class="modal fade" id="tambah_diskusi">
    ...
    <div class="modal-content">
        ...
        <form method="post" action="http://localhost/elearning/guru/?system=materi&aksi=tambah_diskusi">
...
<div class="modal fade" id="edit_diskusi">
    ...
    <div class="modal-content">
        ...
        <form method="post" action="http://localhost/elearning/guru/?system=materi&aksi=edit_diskusi">
        <div class="modal-body">
              <div>
                <div>
...
<div class="modal fade" id="edit_komentar">
    ...
    <div class="modal-content">
        ...
        <form method="post" action="http://localhost/elearning/guru/?system=materi&aksi=edit_komentar">
        <div class="modal-body">
              <div>
                <div>
